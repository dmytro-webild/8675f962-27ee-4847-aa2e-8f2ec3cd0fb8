    ...
    >
      ...
      <div id="metrics" data-section="metrics">
        <MetricCardEleven
          ...
          animationType="slide-up"
          metrics={[
            { id: "metric-1", value: "50K+", title: "Followers", description: "Across all streaming platforms" },
            { id: "metric-2", value: "2.5M", title: "Streams", description: "Monthly combined across platforms" },
            { id: "metric-3", value: "15", title: "Releases", description: "Albums, EPs, and singles" },
            { id: "metric-4", value: "25+", title: "Countries", description: "Where music resonates" }
          ]}
        />
      </div>
